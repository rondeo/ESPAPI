...
module.exports = {
    ...
    getData: function (userQuery) {
        return new Promise(function(resolve, reject) {
            exec('python -m esp_cli.snow_exporter --query=nameSTARTSWITH' + userQuery + ' --table=u_it_service_offering --config=/opt/esp/access.yaml --format=json -f name,operational_status,ip_address',
                function (error, stdout, stderr) {
